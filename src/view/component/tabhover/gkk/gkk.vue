<template>
    <div>         
        <el-carousel height="450px" :autoplay="false" arrow="never">
            <el-carousel-item>
                <div class="bjnewsImg">
                    <ul>
...
<script>
import {imgListAbver,newsList} from '../../../../axios/api'
...
.bjnewsImg{width:450px;overflow:hidden;}
.bjnewsImg ul{width:480px;}
.bjnewsImg li{width:220px;float:left;height:186px;line-height:18px;overflow:hidden;margin:0 10px 0 0;}
.bjnewsImg li img{width:220px;height:150px;display:block}
.bjnewsImg li p{height:36px;overflow:hidden;}
.first{position:relative;font-size:16px;margin:10px 0 0;padding-bottom:5px;}
